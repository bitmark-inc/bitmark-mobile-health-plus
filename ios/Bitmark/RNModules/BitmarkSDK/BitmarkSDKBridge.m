...
RCT_EXTERN_METHOD(migrateOldKeychain:(RCTResponseSenderBlock)callback)
...
RCT_EXTERN_METHOD(downloadBitmarkWithGrantId:(NSString *)sessionId:(NSString *)grantId:(RCTResponseSenderBlock)callback)
