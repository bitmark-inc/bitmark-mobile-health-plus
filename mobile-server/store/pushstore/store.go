...
type PushStore interface {
	...
	AddPushToken(ctx context.Context, account, uuid, platform, client string, intercomUserID *string) error
	...
	QueryPushTokensByAccount(ctx context.Context, account string) (map[string]map[string][]string, error)
	QueryPushTokensByIntercom(ctx context.Context, intercomUserID string) (map[string]map[string][]string, error)
