...
import ReactNative, {
  StyleSheet,
  Image, View, TouchableOpacity, Text, SafeAreaView, ScrollView, TextInput, Picker
} from 'react-native';
    ...
    return (
      <SafeAreaView style={styles.bodySafeView}>
        ...
        {!this.state.isEditing && <ScrollView contentContainerStyle={styles.body}>
          ...
          <ShadowComponent style={styles.cardBody}>
            <ShadowTopComponent contentStyle={styles.cardHeader}>
              <Text style={styles.cardTitle}>{'Active Clinical Diagnoses'.toUpperCase()}</Text>
          ...
          <ShadowComponent style={styles.cardBody}>
            <ShadowTopComponent contentStyle={styles.cardHeader}>
              <Text style={styles.cardTitle}>{'CURRENT TREATMENTS & DOSAGES'.toUpperCase()}</Text>
          ...
          <ShadowComponent style={styles.cardBody}>
            <ShadowTopComponent contentStyle={styles.cardHeader}>
              <Text style={styles.cardTitle}>{'ALLERGIES & REACTIONS'.toUpperCase()}</Text>
          ...
          <ShadowComponent style={styles.cardBody}>
            <ShadowTopComponent contentStyle={styles.cardHeader}>
              <Text style={styles.cardTitle}>{'Visible & Invisible Disabilities'.toUpperCase()}</Text>
                ...
                <View style={{ flex: 1, flexDirection: 'row', marginTop: 16 }}>
                  <View style={{ flex: 1, flexDirection: 'column' }}>
                    ...
                    <DatePicker style={styles.mmrInformationValueInput}
                      date={this.state.mmrInformation.birthday || moment().toDate()}
                      onDateChange={(birthday) => this.updateMMRInformationState.bind(this)({ birthday })}
                      format="DD|MM|YYYY"
                      showIcon={false}
                      mode="date"
                      customStyles={{
