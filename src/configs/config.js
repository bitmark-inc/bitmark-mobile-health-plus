...
let config = {
  isIPhoneX,
  network,
  localization: 'en', //DeviceInfo.getDeviceLocale()
...
// code-push release-react 'BitmarkHealthPlus' ios --pre "BitmarkHealthPlus dev" --mandatory true --plistFile=ios/Info-dev.plist
