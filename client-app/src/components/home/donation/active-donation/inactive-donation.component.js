...
export class InactiveDonationComponent extends React.Component {
  ...
  render() {
    return (<View style={inactiveStyles.disableContent}>
      ...
      <Text style={inactiveStyles.enableMessage}>Your activity and personal health data is of value to public health researchers. Use Bitmark to donate your bitmarked data to help advance their studies.</Text>
