...
import loadingStyles from './bitmark-legal.component.style';
    ...
    return (
      <BitmarkComponent
        ...
        content={(<View style={[loadingStyles.body]}>
          ...
          {this.state.displayedContentName === Contents.PrivacyPolicy.name && <View style={loadingStyles.swipePageContent}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>WEBSITE INFORMATION COLLECTION AND USE</Text>
            ...
            <Text style={loadingStyles.contentSubTitleText}>APPLICATION INFORMATION COLLECTION AND USE</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>PUBLIC INFORMATION</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>COOKIES</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>WEB BEACONS?</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>SPECIFIC SERVICE PROVIDERS</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>SECURITY</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>LINKS TO OTHER SITES</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>OUR POLICY TOWARDS CHILDREN</Text>
            ...
            <Text style={loadingStyles.contentSubTitleText}>CHOICES AND CONTROL</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>CHANGES TO THIS PRIVACY POLICY</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Mailer.mail({ subject: 'Suggestion for Bitmark Health', recipients: [url], }, (error) => {
              if (error) {
                Alert.alert('Error', 'Could not send mail.');
              }
          ...
          {this.state.displayedContentName === Contents.TermOfService.name && <View style={loadingStyles.swipePageContent}>
            <Text style={loadingStyles.contentCreatedText}>Last Updated: 19 JAN, 2018{'\n'}</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>SERVICES DESCRIPTION AND AGREEMENT APPLICABILITY</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
            ...
            <Text style={loadingStyles.contentSubTitleText}>ACCESS TO THE SERVICES</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
              if (url.indexOf('@bitmark.com') >= 0) {
                Mailer.mail({ subject: 'Suggestion for Bitmark Health', recipients: [url], }, (error) => {
                  if (error) {
            ...
            <Text style={loadingStyles.contentSubTitleText}>TRANSFERRING DIGITAL PROPERTY</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>SERVICES CONTENT, USE AND GENERAL TERMS</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
              ...
              <Text style={[loadingStyles.contentNormalText, { marginTop: 0 }]}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>THIRD-PARTY SERVICES; BITMARK PROPERTY SYSTEM.</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>COPYRIGHT DISPUTE POLICY</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
              if (url.indexOf('@bitmark.com') >= 0) {
                Mailer.mail({ subject: 'Suggestion for Bitmark Health', recipients: [url], }, (error) => {
                  if (error) {
            ...
            <Text style={loadingStyles.contentSubTitleText}>CONTACT</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
              if (url.indexOf('@bitmark.com') >= 0) {
                Mailer.mail({ subject: 'Suggestion for Bitmark Health', recipients: [url], }, (error) => {
                  if (error) {
...
BitmarkLegalComponent.propTypes = {
  navigation: PropTypes.shape({
    navigate: PropTypes.func,
    goBack: PropTypes.func,
    state: PropTypes.shape({
      params: PropTypes.shape({
        displayedContentName: PropTypes.string.isRequired,
      }),
    }),
  }),
}