          ...
          {this.state.displayedContentName === Contents.TermOfService.name && <View style={loadingStyles.swipePageContent}>
            ...
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(20) }]}>1.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(335) }]}>
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(20) }]}>2.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(335) }]}>
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(20) }]}>3.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(335) }]}>
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(20) }]}>4.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(335) }]}>
            ...
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(20) }]}>5.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(335) }]}>
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(20) }]}>6.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(335) }]}>
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(20) }]}>7.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(335) }]}>
