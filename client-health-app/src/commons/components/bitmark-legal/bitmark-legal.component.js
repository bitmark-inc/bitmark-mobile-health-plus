        ...
        content={(<View style={[loadingStyles.body]}>
          ...
          {this.state.displayedContentName === Contents.TermOfService.name && <View style={loadingStyles.swipePageContent}>
            ...
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
              ...
              <Text style={[loadingStyles.contentNormalText]}>The Services consist primarily of tools allowing users to:{'\n'}</Text>
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(30), paddingRight: 0 }]}>1.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(345) }]}>
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(30), paddingRight: 0 }]}>2.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(345) }]}>
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(30), paddingRight: 0 }]}>3.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(345) }]}>
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(30), paddingRight: 0 }]}>4.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(345) }]}>
            ...
            <Text style={loadingStyles.contentSubTitleText}>TRANSFERRING CRYPTO PROPERTY</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={loadingStyles.contentNormalText}>
            ...
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(30), paddingRight: 0 }]}>5.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(345) }]}>
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(30), paddingRight: 0 }]}>6.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(345) }]}>
              ...
              <View style={loadingStyles.contentNormalRow}>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(30), paddingRight: 0 }]}>7.</Text>
                <Text style={[loadingStyles.contentNormalText, { marginTop: 0, width: convertWidth(345) }]}>
