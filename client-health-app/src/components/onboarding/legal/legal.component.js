...
export class LegalComponent extends React.Component {
  constructor(props) {
    ...
    this.printLegal = this.printLegal.bind(this);
  ...
  printLegal() {
    let legalDisplayName = 'BitmarkLegal';
    let legalFilePath = 'https://s3-ap-northeast-1.amazonaws.com/bitmark-mobile-files/3+combination.pdf';

    AppProcessor.doDownloadAndShareLegal(legalDisplayName, legalFilePath).then(filePath => {
      EventEmitterService.emit(EventEmitterService.events.APP_PROCESSING, true);
      Share.share({ title: legalDisplayName, url: filePath }).then(() => {
    ...
    return (
      <BitmarkComponent
        ...
        header={(<View style={[defaultStyle.header, {
          ...
          <View style={[defaultStyle.headerLeft, legalStyle.legalHeaderLeft]}>
        ...
        content={(
          <View style={[legalStyle.body]}>
            <StatusBar hidden={false} />

            <View style={legalStyle.swipePageContent}>
              {/*PRIVACY POLICY*/}
              <View>
                <Text style={[legalStyle.contentTitleText, {paddingTop: 40}]}>PRIVACY POLICY</Text>
              ...
              {/*TERMS OF SERVICE*/}
              <View>
                <Text style={legalStyle.contentTitleText}>TERMS OF SERVICE</Text>
                <Text style={legalStyle.contentCreatedText}>Last Updated: 19 JAN, 2018{'\n'}</Text>
                <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
                  <Text style={legalStyle.contentNormalText}>
