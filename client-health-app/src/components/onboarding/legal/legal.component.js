...
import legalStyle from './legal.component.style';
...
const Contents = {
  DataRetention: {
    name: 'data-retention',
    // filePath: require('./../../../../assets/retention.pdf')
  },
  PrivacyPolicy: {
    name: 'privacy-policy',
    // filePath: require('./../../../../assets/privacy.pdf'),
  },
  TermOfService: {
    name: 'term-of-service',
    // filePath: require('./../../../../assets/term.pdf'),
  },
  GovernancePolicy: {
    name: 'governance-policy',
    // filePath: require('./../../../../assets/governance.pdf'),
  },
}
export class LegalComponent extends React.Component {
  constructor(props) {
    ...
    this.state = {
      passPhrase24Words,
      displayedContentName: Contents.GovernancePolicy.name,
      displayedContent: Contents.GovernancePolicy,
      assetFolderPath: './../../../../assets',
    };

  }
  displayContent(displayedContent) {
    this.setState({ displayedContent, displayedContentName: displayedContent.name });
  }
  ...
  render() {
    return (
      <BitmarkComponent
        ...
        content={(<View style={[legalStyle.body]}>
          <StatusBar hidden={false} />

          {this.state.displayedContentName === Contents.GovernancePolicy.name && <View style={legalStyle.swipePageContent}>
            <Text style={legalStyle.contentTitleText}>GOVERNANCE POLICY</Text>
            ...
            <Text style={legalStyle.contentSubTitleText}>WHY NOT A FOUNDATION?</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>WHY THE INTERNET SYSTEMS CONSORTIUM ("ISC") LICENSE?</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>UPDATES TO THIS GOVERNANCE POLICY</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>QUESTIONS</Text>
          ...
          {this.state.displayedContentName === Contents.PrivacyPolicy.name && <View style={legalStyle.swipePageContent}>
            ...
            <Text style={legalStyle.contentSubTitleText}>PUBLIC INFORMATION</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>COOKIES</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>WEB BEACONS?</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>SPECIFIC SERVICE PROVIDERS</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>DO NOT TRACK</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>SECURITY</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>LINKS TO OTHER SITES</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>OUR POLICY TOWARDS CHILDREN</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Mailer.mail({ subject: 'Suggestion for Bitmark Health', recipients: [url], }, (error) => {
              if (error) {
                Alert.alert('Error', 'Could not send mail.');
              }
            ...
            <Text style={legalStyle.contentSubTitleText}>CHANGES TO THIS PRIVACY POLICY</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Mailer.mail({ subject: 'Suggestion for Bitmark Health', recipients: [url], }, (error) => {
              if (error) {
                Alert.alert('Error', 'Could not send mail.');
              }
          ...
          {this.state.displayedContentName === Contents.TermOfService.name && <View style={legalStyle.swipePageContent}>
            <Text style={legalStyle.contentTitleText}>BITMARK INC. TERMS OF SERVICE</Text>
            <Text style={legalStyle.contentCreatedText}>Last Updated: 19 JAN, 2018{'\n'}</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>SERVICES DESCRIPTION AND AGREEMENT APPLICABILITY</Text>
            ...
            <Text style={legalStyle.contentSubTitleText}>ACCESS TO THE SERVICES</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
              if (url.indexOf('@bitmark.com') >= 0) {
                Mailer.mail({ subject: 'Suggestion for Bitmark Health', recipients: [url], }, (error) => {
                  if (error) {
              ...
              <Text style={legalStyle.contentNormalText}>
                <Text style={{ fontWeight: '600' }}>Basic Conditions.</Text> While bitmarks and the Bitmark Property System generally serve as records of the ownership and transfer of Digital property and are available through the documented interfaces to the Bitmark Property System, the Services are owned by Company, and the Company only grants you permission to use the Services as made available by the Company.{'\n\n'}
            ...
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
                ...
                <Text style={{ fontWeight: '600' }}>Disclosure by Transferor.</Text> You warrant that you and all aspects of the Digital property you may make available through the Services comply with the terms of this Agreement and any Company-published policies. You also warrant that you may legally transfer all rights you purport to transfer in any Digital property you that you use the Services to transfer. You must accurately describe your Digital property and all terms of sale or license to any purchaser.{'\n\n'}
                <Text style={{ fontWeight: '600' }}>Transfer of bitmarks.</Text> Company does not transfer bitmarks or copies of Digital property from a transferor to a recipient except as instructed by the parties. Each transferor and recipient shall have sole and complete discretion whether to enter into transactions with each other, and on what terms, provided that each recipient and transferor represent and warrant to Company that they will comply with this Agreement and all Company-published policies.{'\n\n'}
                ...
                <Text style={{ fontWeight: '600' }}>Payments.</Text> Company uses a third-party payment processor (the "Payment Processor") to enable transferors to use credit cards and other conventional payment mechanisms to pay for transfers of Digital property. Company's current Payment Processor is Stripe. The processing of payments will be subject to the terms, conditions and privacy policies of the Payment Processor in addition to this Agreement. The terms and conditions of the Payment Processor may be found at https://stripe.com/us/terms; the Payment Processor's Privacy Policy may be found at https://stripe.com/us/privacy.{'\n\n'}
            ...
            <Text style={legalStyle.contentSubTitleText}>SERVICES CONTENT, USE AND GENERAL TERMS</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>THIRD-PARTY SERVICES; BITMARK PROPERTY SYSTEM.</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => Linking.openURL(url)} >
              <Text style={legalStyle.contentNormalText}>
            ...
            <Text style={legalStyle.contentSubTitleText}>COPYRIGHT DISPUTE POLICY</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
              if (url.indexOf('@bitmark.com') >= 0) {
                Mailer.mail({ subject: 'Suggestion for Bitmark Health', recipients: [url], }, (error) => {
                  if (error) {
            ...
            <Text style={legalStyle.contentSubTitleText}>CONTACT</Text>
            <Hyperlink linkStyle={{ color: '#0060F2' }} onPress={(url) => {
              if (url.indexOf('@bitmark.com') >= 0) {
                Mailer.mail({ subject: 'Suggestion for Bitmark Health', recipients: [url], }, (error) => {
                  if (error) {
        ...
        footer={(<View style={legalStyle.bottomButtonArea}>
          ...
          }]} onPress={() => this.displayContent(Contents.GovernancePolicy)}>
          ...
          <TouchableOpacity style={legalStyle.lastBottomButton} onPress={() => {
            if (this.state.assetFolderPath) {
              Share.share({ title: this.state.displayedContentName, message: '', url: this.state.assetFolderPath + this.state.displayedContent.filePath });
            }
          }}>
