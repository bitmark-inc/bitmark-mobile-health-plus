            ...
            {!this.state.loading &&
              <View style={propertyDetailStyle.bodyContent}>
                <View style={propertyDetailStyle.contentContainer}>
                  ...
                  {/*VIEW ON BLOCKCHAIN*/}
                  <BitmarkOneTabButtonComponent style={propertyDetailStyle.viewRegistryButton} onPress={() => {
                ...
                <View style={propertyDetailStyle.contentContainer}>
                  ...
                  {/*PREVIEW*/}
                  {this.state.bitmark.status === 'confirmed' &&
                    <BitmarkOneTabButtonComponent style={propertyDetailStyle.imageArea} onPress={() => {
